...
public class GeziBackendClient {
    ...
    public static String removeFavorite(Long userId, Long placeId) throws Exception {
        String url = BASE_URL + "/nosql/favorites?userId=" + userId + "&placeId=" + placeId;

        java.net.http.HttpRequest request = java.net.http.HttpRequest.newBuilder()
                .uri(java.net.URI.create(url))
                .DELETE() // Yasemin'in yazdığı DELETE isteği
                .build();
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("\n=== Yeni Şehir Oluştur ===");
            String newCity = createCity("İzmir", "Türkiye", "Ege'nin güzel kenti", "https://media.timeout.com/images/106098318/750/562/image.jpg");
